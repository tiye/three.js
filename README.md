...
Current version: [r77](https://github.com/mrdoob/three.js/releases/tag/r77).
In this repo the version in converted to `0.77.0` in semantic version for Bower to recognize.
