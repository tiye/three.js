...
Current version: [r75](https://github.com/mrdoob/three.js/releases/tag/r75).
In this repo the version in converted to `0.75.0` in semantic version for Bower to recognize.
